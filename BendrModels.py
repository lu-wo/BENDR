...
"""
ConvEncoderBENDR is the convolutional encoder (part 1) of the architecture.
"""
class _BENDREncoder(nn.Module):
    ...
    def load(self, filename, strict=True, cpu=False):
        if cpu:
...
"""
Contextualizer is the transormer encoder (part 2) of the architecture.
"""
