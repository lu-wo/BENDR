...
class BENDR(pl.LightningModule):
    ...
    def __init__(self, encoder, context_fn, mask_rate=0.1, mask_span=6, learning_rate=0.01, temp=0.5,
        ...
        self.encoder_grad_frac = encoder_grad_frac
...
def create_bendr(params):

    context_fn = BENDRContextualizer(params['encoder_h'], params['hidden_feedforward'], params['heads'], params['layers'], params['dropout'], params['activation'],
                 params['position_encoder'], params['layer_drop'], params['mask_p_t'], params['mask_p_c'], params['mask_t_span'], params['mask_c_span'],
                 params['start_token'], params['finetuning'])
    
    encoder = ConvEncoderBENDR(params['in_features'], params['encoder_h'], params['enc_width'],
                 params['enc_dropout'], params['projection_head'], params['enc_downsample'])
